...
### Installering:
```
npm install nav-frontend-core nav-frontend-typografi-style stepper-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/stepper-style
<!-- AUTO-GENERATED-CONTENT:END *-->